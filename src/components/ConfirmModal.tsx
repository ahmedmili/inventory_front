...
export default function ConfirmModal({
  ...
  const defaultTitle = type === 'danger' ? 'Confirmer la suppression' : 'Confirmer l\'action';

  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title || defaultTitle} size="md" animation="slide">

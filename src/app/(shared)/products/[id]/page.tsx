        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="text-center py-12">
            <p className="text-gray-500 mb-4">
              {isServerError
                ? 'Erreur serveur lors du chargement du produit. Vérifiez que le backend est démarré (ex. port 4000) et que NEXT_PUBLIC_API_URL pointe vers lui.'
                : 'Produit non trouvé'}
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3">
              {isServerError && mutate && (
                <button
                  type="button"
                  onClick={() => mutate()}

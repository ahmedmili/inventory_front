      ...
      <RouteGuard>
        <div className="max-w-4xl mx-auto p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-red-800">Vous n'avez pas la permission de créer une importation.</p>
          </div>
        </div>
      </RouteGuard>
    );
    ...
    <RouteGuard>
      <div className="max-w-7xl mx-auto min-w-0 w-full p-4 sm:p-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Nouvelle Importation</h1>
            <p className="text-sm text-gray-600 mt-1">Importer des produits depuis un fournisseur</p>
          </div>
          <Link
            href="/imports"
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {importLines.length > 0 && (
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Produits à importer</h2>
